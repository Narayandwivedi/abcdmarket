...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const isActive = (path) => {
    ...
    if (path === '/' && (location.pathname === '/add-product' || location.pathname.startsWith('/edit-product'))) return true;
    return false;
  };
  ...
  return (
    <div className={`bg-gray-900 text-white w-72 max-w-[85vw] lg:w-64 min-h-screen flex flex-col fixed left-0 top-0 z-50 transform transition-transform duration-300 ease-in-out ${
      ...
      <div className="p-4 sm:p-6 border-b border-gray-700 flex items-center justify-between">
        ...
        <button
          onClick={onClose}
          className="lg:hidden p-1 rounded-md text-gray-400 hover:text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
