...
const ChatSupport = () => {
  ...
  const categories = ['Order Related', 'Product Inquiry', 'Technical Support', 'Return/Refund', 'Other'];
  ...
  const filteredConversations = userConversations.filter(conversation => {
    if (filters.search) {
      ...
      return conversation.user?.fullName?.toLowerCase().includes(searchLower) ||
      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <div className="text-center">
          <div className="relative">
            ...
            <div className="animate-spin rounded-full h-20 w-20 border-4 border-cyan-500 border-t-transparent absolute top-0 left-1/2 transform -translate-x-1/2"></div>
          </div>
          <div className="mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200 bg-gray-50 hover:bg-white"
              >
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200 bg-gray-50 hover:bg-white"
                />
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-4 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden flex flex-col ${showChatDetail ? 'hidden lg:flex' : ''}`} style={{ height: 'calc(100vh - 200px)' }}>
            <div className="bg-gradient-to-r from-cyan-500 to-blue-600 p-4 flex-shrink-0">
              ...
              <p className="text-blue-100 text-sm mt-1 hidden lg:block">Click on a conversation to view details</p>
              <p className="text-blue-100 text-sm mt-1 lg:hidden">Tap on a conversation to view details</p>
            </div>
              ...
              filteredConversations.map((conversation) => {
                ...
                return (
                  <div
                    ...
                    className={`p-3 border-b cursor-pointer transition-all duration-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-cyan-50 ${
                      conversation.hasUnread ? 'bg-gradient-to-r from-blue-50 to-cyan-50 border-l-4 border-l-blue-500' : ''
                    } ${isSelected ? 'bg-gradient-to-r from-cyan-100 to-blue-100 border-l-4 border-l-cyan-500' : ''}`}
                  >
        ...
        <div className={`lg:col-span-8 bg-white ${showChatDetail ? 'fixed inset-0 z-50 lg:relative lg:rounded-xl lg:shadow-lg lg:border lg:border-gray-100' : 'rounded-xl shadow-lg border border-gray-100'} overflow-hidden flex flex-col ${!showChatDetail ? 'hidden lg:flex' : ''}`} style={{ height: showChatDetail ? '100vh' : 'calc(100vh - 200px)' }}>
          {selectedMessage ? (
            <div className="h-full flex flex-col">
              ...
              <div className="lg:hidden bg-gradient-to-r from-cyan-500 to-blue-600 p-4 flex items-center space-x-3 flex-shrink-0">
                <button
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-cyan-200 text-sm">{selectedMessage.userId?.email}</p>
                  </div>
                </div>
              </div>
                    ...
                    .map((message, index) => (
                      <div key={message._id} className="space-y-4">
                        ...
                        <div className="flex justify-end">
                          <div className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-2xl p-4 max-w-sm shadow-lg">
              ...
              <div className="p-3 bg-white border-t border-gray-200 flex-shrink-0">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 bg-gray-50 text-sm placeholder-gray-500"
                  />
                  <button
                    onClick={() => {
                      // Get the latest message from this user for reply
                    ...
                    className="bg-cyan-500 hover:bg-cyan-600 text-white p-2 rounded-full disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    {isReplying ? (
            ...
            <div className="h-full flex items-center justify-center bg-gradient-to-br from-slate-50 to-cyan-50">
              <div className="text-center p-8">
                <div className="bg-gradient-to-r from-cyan-500 to-blue-600 p-6 rounded-full w-24 h-24 mx-auto mb-6 shadow-lg">
                ...
                <p className="text-gray-500 max-w-sm mx-auto leading-relaxed">
                  Choose a conversation from the left panel to view messages and send replies to your customers.
                </p>
